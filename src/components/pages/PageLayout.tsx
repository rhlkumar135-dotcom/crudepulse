    ...
    <div className="min-h-screen bg-bg">
      ...
      <div className="relative z-10 p-4 max-w-[1600px] mx-auto">
        <div className="mb-4">
          ...
          <p className="text-[9px] text-[#6b7280] tracking-[0.2em] uppercase mt-1"
  ...
  return (
    <div className={`cyber-card overflow-hidden ${className}`}>
      <div className="flex items-center gap-3 px-5 pt-4 pb-2">
        ...
        {tag && (
          <span className="text-[8px] font-mono text-[#6b7280] bg-white/[0.03] px-1.5 py-0.5 rounded border border-white/[0.04]">
            {tag}
          </span>
        )}
      </div>
